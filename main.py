...
#conn = mysql.connector.connect(host="localhost",user="root",password = "",database="tcsprojectdb")
#cursor = conn.cursor()
'''
#cursor.execute("CREATE DATABASE TCSPROJECTDB")
emp Id
emp Name
emp address
emp dob
emp mobileNumber
cursor.execute("CREATE TABLE employee (empid INT,empName VARCHAR(255), empAddress VARCHAR(255), empdob Da)")
INSERT INTO `employee` (`empId`, `empName`, `empAddress`, `empDob`, `empPhone`) VALUES ('101', 'Rohan Nirmal', 'navsari, gujarat', '1999-01-10', '9898898952');
conn.close()
'''
